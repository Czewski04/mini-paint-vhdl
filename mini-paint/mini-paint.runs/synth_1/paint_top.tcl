...
synth_design -top paint_top -part xczu3eg-sfvc784-2-e
...
write_checkpoint -force -noxdef paint_top.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file paint_top_utilization_synth.rpt -pb paint_top_utilization_synth.pb"  } 
